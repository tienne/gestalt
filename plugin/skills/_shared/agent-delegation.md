...
**대신 인라인은 원본과 갈라진다.** [`untrusted-input.md`](./untrusted-input.md)를 고치면 인라인한 자리도 같이 고쳐야 한다. 이 레포가 줄곧 잡아온 "같은 규칙이 두 곳에" 문제를 여기서는 알고 받아들인 것이다 — 경로가 안 풀리는 것보다 사본이 낫다. 옮길 때는 **원본 규칙 목록과 나란히 놓고 하나씩 대조한다.** 적용 대상이 아닌 규칙은 빼도 되지만 뺐다는 걸 알고 빼야 한다.
