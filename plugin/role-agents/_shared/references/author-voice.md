...
> **"건"을 글자로 매칭하면 안 된다.** 같은 글자가 층위가 세 가지로 갈린다.
>
> | 고칠 것 | 그대로 둘 것 |
> |---|---|
...
> 수량을 세는 자리면 **세는 대상이 사물인지 안건인지** 다시 본다. 판정법은 그 자리에
> "안건"을 넣어보는 것이다 — "확인이 필요한 안건 2개"는 말이 되고 "버그라는 안건 8개"는
> 안 된다. 안건 자리까지 "개"로 바꾸면 사람이 쓴 말을 고치게 된다.
