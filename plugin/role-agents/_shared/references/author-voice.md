...
아래 세 쌍은 실제 리뷰 코멘트에서 나온 교정 사례다. 패턴만 참고하고 문장은 복붙하지 않는다.
...
| c: 여섯 건은 매끄럽게 다듬는 수준이고 | c: 여섯 개는 가볍게 손보면 되는 것들이에요 | 형식명사 "수준"으로 정도 뭉개기 + 세는 단위 "건"(I-5) |
...
- 셀 수 있게 말할 때는 "8건"보다 **"8개"** 나 "여덟 개" (사무투 분류사 회피, ai-tell I-5)
...
> 규칙을 적용하기 전에 그 자리가 **수량을 세는 자리인지** 확인한다.
