...
**어휘 선택**: 불필요한 영어 약어와 한자어 대신 실제로 많이 쓰는 단어를 고른다.
- 영어 약어: "ETA" → "예상 완료 시간", "LGTM" → "괜찮아 보여", "TBD" → "미정", "FYI" → "참고로", "ASAP" → "빨리/최대한 빨리" 등
- 한자어: "구현" → "만들다/작성하다", "확인" → "보다/살피다", "수행" → "하다", "명세" → "내용/설명", "인터페이스" → 맥락에 따라 "화면/연결/창구" 등 구체적 단어
- 단, 업계 표준 용어(API, PR, DB 등)는 그대로 쓴다 — 풀어쓰면 오히려 어색한 것들은 예외`;
