 ...
 * 조사 도와 로는 NOT_HANGUL 로 "산출도구", "산출로직"을 뺀다.
...
const DETECTORS: Detector[] = [
  ...
  // 잘못 감지하는 빈도만 낮췄다. 형태만으로는 여기까지가 한계다.
  //
  ...
  // 대신 그 토큰에서 문장부호와 주격, 주제 조사를 뺀다. 안 빼면 창이 절 경계를 넘어
  // "제가 보기에 그 논문이 지적한 부분"의 3인칭 주어를 통째로 삼켜서, 화자 갈래가
  // 3인칭을 가르려고 존재하는 이유가 없어진다.
  //
