...
// ─── Interview Tool ─────────────────────────────────────────────
export const interviewInputSchema = guardObject(
  z.object({
...
// ─── Spec Tool ──────────────────────────────────────────────────
export const specInputSchema = guardObject(
  z.object({
    sessionId: z
      .string()
      .optional()
...
export const executeInputSchema = guardObject(
  z.object({
    ...
    sessionId: z
      ...
      .optional()
      .describe(
        "Execute session ID. 'active'(현재 활성 세션) 또는 'latest'(가장 최근 갱신)도 가능.",
      ),
    changedFiles: z
      .array(z.string())
      .optional()
...
// ─── Create Agent Tool ──────────────────────────────────────────
export const agentCreateInputSchema = guardObject(
  z.object({
...
// ─── Benchmark Tool ─────────────────────────────────────────────
export const benchmarkInputSchema = guardObject(
  z.object({
...
// ─── Status Tool ────────────────────────────────────────────────
export const statusInputSchema = guardObject(
  z.object({
    sessionId: z
      .string()
      .optional()
...
export const graphVisualizeInputSchema = guardObject(
  z.object({
    repoRoot: z.string().describe('Absolute path to the repository root'),
    port: z
      .number()
...
export const prInputSchema = guardObject(
  z.object({
    action: z
      .enum(PR_ACTIONS)
      .describe(
    ...
    head: z
      .string()
      .optional()
      .describe('create: 리뷰 대상 브랜치(기본 HEAD), update: 옮겨갈 커밋'),
