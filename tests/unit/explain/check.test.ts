...
describe('analogy 축', () => {
  ...
  it.each([
    ...
    ['다고 생각해보', '여러 사람이 같은 공책에 동시에 적는다고 생각해보세요.'],
    ['다고 생각해 보', '여러 사람이 같은 공책에 동시에 적는다고 생각해 보세요.'],
    ['라고 생각해보', '옆집 우편함이라고 생각해보세요.'],
    ['라고 생각해 보', '옆집 우편함이라고 생각해 보세요.'],
    ['떠올려보', '옆집 우편함을 떠올려보세요.'],
  ...
  // 표지를 어간이나 '고'까지로 되돌리면 여기 있는 문장들이 통과해버린다.
  it.each([
    '곰곰이 생각해보니 이 방법이 맞았어요.',
    '곰곰이 생각해 보니 이 방법이 맞았어요.',
    '밥을 먹고 생각해보니 좋았어요.',
    '다 읽고 생각해 보면 답이 나와요.',
